...
const FEATURES = [
  ...
  },
  {
    ...
    tagline: 'Right-size & optimize',
    desc: 'Right-size your cloud resources across AWS, Azure, and GCP. Get upgrade/downgrade recommendations based on utilization metrics.',
    color: '#f97316',
  ...
  },
  {
    ...
    desc: 'Real-time infrastructure health monitoring, drift detection between IaC and live state, and cost anomaly tracking for FinOps.',
    color: '#38bdf8',
